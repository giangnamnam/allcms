...
var gEnd=[curDate.getFullYear()+3,12,31];	// static calendar range end at [Year,Month,Date]
//var gsOutOfRange="Xin loi, thoi gian qua gioi han!";	// out-of-date-range error message
var gsOutOfRange = "Out-of-date-range error!";
...
var gcCalBG="#D1D1D6";	// the background color of the outer calendar panel.
...
var gcSat="white";	// Saturday font color
var gcSatBG="#A00000";	// Saturday background color
var gcSun="white";	// Sunday font color
var gcSunBG="#A00000";	// Sunday background color

var gcOtherDay="#D1D1D6";	// the font color of days in other months; when hiding, it's also the background color.
var giShowOther=8;	// control the look of days in OTHER months. 1: show date & agendas effects; 2: show selected & today effects; 4: hide days in previous month; 8: hide days in next month. NOTE: values can be added up to create mix effects.

var gbFocus=true;	// whether to enable the gcToggle highlight whenever mouse pointer focuses over a calendar cell.
var gcToggle="Gray";	// the highlight color for the focused cell
