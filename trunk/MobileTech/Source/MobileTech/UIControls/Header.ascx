    ...
    <div id="header">
        ...
        <div id="hd-right">
            ...
            <div id="nav">
                ...
                <span id="plans" class="nav-a" style="border-bottom: 4px solid #ff00c2"><a href="" onclick="javascript: alert('Under construction!'); return false;">
                    plans</a></span> <span id="contact" class="nav-a" style="border-bottom: 4px solid #ff5a00">
                        <a href="Contact.aspx">contact</a></span>
            </div>
        </div>
    </div>
</div>
