<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Share/AdminSite.Master" AutoEventWireup="true" Inherits="MobileTech.Admin.Accessories.Default" Codebehind="Default.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div id="sidebar">
        <ul class="sideNav">
            <li><a id="A1" href="../CategoryAcc" class="active" runat="server">Category</a></li>
        </ul>
    </div>
    <div id="main1" style="width: 100%">
        <div align="right">
            <asp:Button ID="btnAdd" runat="server" Text="Add" Width="90px" CausesValidation="False"
        ...
        <asp:DataGrid ID="gridProduct" runat="server" Width="100%" AllowPaging="True" AutoGenerateColumns="False"
            ...
            <Columns>
                ...
                <asp:BoundColumn DataField="AccessoriesPrice" HeaderText="Accessories Price"></asp:BoundColumn>
